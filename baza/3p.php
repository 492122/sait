...
<div id="cont1">
	<div class="tab">
  <button class="tablinks" onclick="openCity(event, 'a')">Наибольший общий делитель</button>
  <button class="tablinks" onclick="openCity(event, 'b')">Сумма целых чисел</button>
  <button class="tablinks" onclick="openCity(event, 'c')">Определение чётности</button>
...
<div id="b" class="tabcontent">
  <h3>Сумма целых чисел</h3>
 <img src="whilesum.png" id="me1">

    <br>
  <br>
  </div>
<div id="c" class="tabcontent">
  <h3>Определение чётности</h3>
 <img src="chet.png" id="me1">
    <br>
  <br>
</div>
